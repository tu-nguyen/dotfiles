...
# General Tweaks
# ------------------------------------------
# Disable "Shortcut" Arrow on Icons
...
# Disable automatic reboot after Windows Updates
...
# Prioritize Games for Resource Allocation
